...
const Contact = () => {
  return (
    <section id="contact" className="bg-gray-900 text-white py-4 mt-10">
      <div className="container mx-auto flex justify-center space-x-6">
        <a href="https://m.facebook.com/ascorpkbutad" target="_blank">
          <svg className="w-6 h-6 fill-white hover:fill-blue-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <a href="https://github.com/loi08" target="_blank">
          <svg className="w-6 h-6 fill-white hover:fill-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <a href="mailto:kenneth.irvinb@gmail.com" target="_blank">
          <svg className="w-6 h-6 fill-white hover:fill-red-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
