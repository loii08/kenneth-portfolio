        ...
        <li>
          <div className="container mx-auto flex justify-start space-x-6">
            <a href="https://m.facebook.com/ascorpkbutad" target="_blank" rel="noopener noreferrer">
              <svg className="w-8 h-8 hover:fill-blue-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <a href="https://github.com/loii08" target="_blank" rel="noopener noreferrer">
              <svg className="w-8 h-8 hover:fill-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <a href="mailto:kenneth.irvinb@gmail.com" target="_blank" rel="noopener noreferrer">
              <svg className="w-8 h-8 hover:fill-red-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
